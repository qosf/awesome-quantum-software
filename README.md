...
- [quantum-os](https://github.com/quantumos-org/quantum-os)  Operating system bases on Linux kernel for quantum computing.uantum 
...
- [Qudit Team](https://github.com/Vanimiaou/QuditsTeam) - Repository to extend Qiskit versatility to higher dimensional quantum states.
