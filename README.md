...
- [WERR](https://github.com/pCwOrM/werr) - Numerical simulation framework for black hole evaporation and Page curve entanglement entropy recovery via non-dissipative modular error kernels.
